...
namespace AtelierResleriana.Localization.Utilities
{
    public class EnglishLocalizer : ILocalizer
    {
        ...
        - メーヴェ・シュテルネンリヒト (メーヴェ) → Mowen Sternenlicht (Mowen) - Adventurer and Resna's mother, who has spent years searching for her missing husband Julius
        ...
        - クレオ・ランターナ (クレオ) → Creo Lantarna (Creo) - Princess of the Kingdom of Lantarna with a talent for combat who led troops on the southern frontier; formed the Star Vanguard unit, which was wiped out by Held and Zero; sibling of Orpheus and Richard (Roman)
        """;
        ...
        private static Dictionary<string, string> SpeakerNotes = new Dictionary<string, string>
        {
            ...
            { "ヤンネ", "Janne is one of the most skilled Sacred Knights of Nova. She grew up as a sisterly figure to Alvina and mentors Bepp as a Sacred Knight. She uses 'Lady Creo' when addressing Creo Lantarna (prior to being told to drop formalities in ch31 003)." },
            ...
            { "メーヴェ", "Mowen is Resna's mother and a seasoned adventurer who has been traveling the world for years searching for her missing husband Julius. She's warm and energetic, quickly befriending people and showing genuine interest in those around her. She takes pride in Resna's growth but hasn't seen her daughter in a long time. She sometimes jokingly invites people to call her 'Big Sis Mowen'." },
            ...
            { "クレオ", "Creo is the princess of the Kingdom of Lantarna, but she strongly dislikes formality and prefers to be called simply 'Creo' without any title. She has a natural talent for combat and spent time commanding troops on the southern frontier rather than attending to court duties. She formed a special unit called the Star Vanguard (光星隊) which was wiped out by Held and Zero, and she carries a personal debt she is determined to settle. Her older brother Orpheus handles affairs of state; her other brother is Richard, who travels as Roman Kalman — she treats him with fond but noticeably casual familiarity. She speaks directly and energetically, quick to act rather than wait. When learning Held had already moved on, her immediate instinct was to pursue rather than stand by." },
